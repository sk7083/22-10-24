...
public interface ProductService {
	 ...
	 * @return 제품 등록 여부(true / false) => 제품 중복 x
	 * */	
	//인터페이스에선 쓰지않아도 자동으로 접근제한자가 들어감
	 ...
	 * */	
	boolean updateProduct(List<Product> productList, int index, Product newProduct);
	 ...
	 * @return 삭제 여부
	 * */
	boolean deleteProduct(List<Product> productList, Product project);
