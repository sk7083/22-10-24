-- 회원 등록
UPDATE `small_jik`.`member` SET `me_id` = 'abc', `me_pw` = 'abc', `me_name` = 'ABC마트', `me_birth` = '2000-01-01' WHERE (`me_id` = 'a');
UPDATE `small_jik`.`member` SET `me_id` = 'qwe', `me_pw` = 'qwe', `me_name` = '홍길동', `me_birth` = '2000-01-01' WHERE (`me_id` = 'a_bc');
INSERT INTO `small_jik`.`member` (`me_id`, `me_pw`, `me_name`, `me_birth`, `me_authority`, `me_point`) VALUES ('admin', 'admin', '관리자', '2000-01-01', 'ADMIN', '0');
INSERT INTO `small_jik`.`member` (`me_id`, `me_pw`, `me_name`, `me_birth`, `me_authority`, `me_point`) VALUES ('hi', 'hi', '고길동', '2002-10-10', 'MEMBER', '0');
...
옵션	- 빨강, 노랑, 흰색
- 의류 - 여성, 세미 크롭 맨투맨, 바블링브룩 여성용 세미 크롭 맨투맨, 10, 17000
옵션 - S, M, L
- 의류 - 남성, 긴판 카라티, 빅사이즈클럽 긴팔 카라티, 20, 24900
옵션	- 흰색 S, 흰색 M, 흰색 L, 남색 M, 남색 L
- 의류 - 남성, 7부 브이넥 티셔츠, 해리슨 남성용 브이넥 7부 티셔츠, 20, 24900
옵션 - XS, S, M, L, XL
- 의류 - 남녀공용, 기모 조거팬츠, 우드파카 기모 조거팬츠, 5, 24800
옵션 - 24인치, 26인치, 28인치, 30인치, 32인치
...
('세미 크롭 맨투맨', '바블링브룩 여성용 세미 크롭 맨투맨', now(), 10, 17000, 1),
('긴판 카라티', '빅사이즈클럽 긴팔 카라티', now(), 20, 24900, 2),
('7부 브이넥 티셔츠', '해리슨 남성용 브이넥 7부 티셔츠', now(), 20, 24900, 2),
('기모 조거팬츠', '우드파카 기모 조거팬츠', now(), 5, 24800, 4),
('슬롭 스키니', '블랙 기모 슬림 스키니', now(), 100, 51840, 4);
