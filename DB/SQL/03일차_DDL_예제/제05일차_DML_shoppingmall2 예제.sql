...
me_authority varchar(20) not null
);

create table address(
ad_num int auto_increment primary key not null,
ad_address varchar(30) not null,
ad_birth varchar(30) not null,
ad_name varchar(30) not null
);

create table order(
or_num int auto_increment primary key not null,
or_
);
